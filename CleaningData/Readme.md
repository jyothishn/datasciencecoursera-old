...
=====================
Assumptions:
 - The script reads from "./UCI HAR Dataset/" folder under the current working directory. 
 - The script also assumes that the zip file is extracted and folder structure has not been modified.
 - If the location is different or the folder structure is modified, look at the "read.table" statements, and correct the file path accordingly
...
- Reads th training and test data and merge them with row bind.
